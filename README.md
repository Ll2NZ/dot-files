...
```zsh
# first, make sure you're in your user directory and create a new bin directory
cd ~/
mkdir bin
cd bin

# second, create a new file create-app and make sure it's an executable
touch create-app
...
# third, create a new file webpack-packages and make sure it's an executable
...
# fourth, create a new file package.json and copy the contents of the file
...
# open .bashrc file and place the following two lines of code (if .bashrc isn't there, make one!)
